...
def playF4mLink(url,name='MitV[COLOR blue] HD[/COLOR]',proxy=None,use_proxy_for_chunks=False,auth_string=None,streamtype='HDS',setResolved=False,swf=""):
